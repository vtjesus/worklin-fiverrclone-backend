...
const getJobByIdController = (dependencies) => {
    const { useCases: { getJobPostByIdUseCase }, } = dependencies;
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const JobPosts = yield getJobPostByIdUseCase(dependencies).execute(freelancerId);
